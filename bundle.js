...
var person = new PersonType('Todor');
...
var person1 = new PersonClass("Todor");
...
var PersonType2 = function () {
	"use strict";

	var PersonType2 = function PersonType2(name) {
...
var CustumaHTMLElement = function () {
	function CustumaHTMLElement(element) {
		_classCallCheck(this, CustumaHTMLElement);

		this.element = element;
	}

	_createClass(CustumaHTMLElement, [{
		key: 'html',
		get: function get() {
...
var MyClass = function () {
	...
	_createClass(MyClass, [{
		key: 'createIternator',
		value: regeneratorRuntime.mark(function createIternator() {
			return regeneratorRuntime.wrap(function createIternator$(_context) {
				while (1) {
...
var iterator = instance.createIternator();
			...
			return regeneratorRuntime.wrap(function value$(_context2) {
				while (1) {
					switch (_context2.prev = _context2.next) {
						case 0:
							return _context2.delegateYield(this.items.values(), 't0', 1);
...
var PersonClass3 = function () {
	function PersonClass3(name) {
		_classCallCheck(this, PersonClass3);

		this.name = name;
	}

	_createClass(PersonClass3, [{
		key: 'sayName',
		value: function sayName() {
			console.log(this.name);
		}
...
var person3 = PersonClass3.create('Todor');
person3.sayName();
...
var Square1 = function (_Rectangle) {
	_inherits(Square1, _Rectangle);

	function Square1(length) {
		_classCallCheck(this, Square1);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(Square1).call(this, length, length));
	}
...
var Square3 = function (_getBase) {
	_inherits(Square3, _getBase);

	function Square3(length) {
		_classCallCheck(this, Square3);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(Square3).call(this, length, length));
	}
...
function mixin() {
	...
	Object.assign.apply(Object, [base.prototype].concat(mixins));
	return base;
}

var Square4 = function (_mixin) {
	_inherits(Square4, _mixin);

	function Square4(length) {
		_classCallCheck(this, Square4);

		var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(Square4).call(this));
...
var MyArray = function (_Array) {
	...
	function MyArray() {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(MyArray).apply(this, arguments));
	}
...
var MyDerivedClass1 = function (_MyClass) {
	_inherits(MyDerivedClass1, _MyClass);

	function MyDerivedClass1() {
		_classCallCheck(this, MyDerivedClass1);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(MyDerivedClass1).apply(this, arguments));
	}

	return MyDerivedClass1;
}(MyClass1);

//empty

var MyDerivedClass2 = function (_MyClass2) {
	_inherits(MyDerivedClass2, _MyClass2);

	function MyDerivedClass2() {
		_classCallCheck(this, MyDerivedClass2);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(MyDerivedClass2).apply(this, arguments));
	}

	_createClass(MyDerivedClass2, null, [{
		key: Symbol.species,
		get: function get() {
			return MyClass1;
		}
	...
	return MyDerivedClass2;
}(MyClass1);

var instance1 = new MyDerivedClass1('foo'),
...
var Rectangle4 = function () {
	function Rectangle4(length, width) {
		_classCallCheck(this, Rectangle4);
...
var Square5 = function (_Rectangle2) {
	_inherits(Square5, _Rectangle2);

	function Square5(length) {
		_classCallCheck(this, Square5);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(Square5).call(this, length, length));
	}
...
var Rectangle5 = function (_Shape) {
	_inherits(Rectangle5, _Shape);

	function Rectangle5(length, width) {
		_classCallCheck(this, Rectangle5);

		var _this8 = _possibleConstructorReturn(this, Object.getPrototypeOf(Rectangle5).call(this));
